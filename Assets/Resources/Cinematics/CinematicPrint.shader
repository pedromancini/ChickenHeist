Shader "ChickenHeist/CinematicPrint"
{
    Properties { _BaseMap("Font atlas",2D)="white" {} _BaseColor("Ink",Color)=(1,1,1,1) }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Output i):SV_Target{half a=SAMPLE_TEXTURE2D(_BaseMap,sampler_BaseMap,i.uv).a;clip(a-.3h);return _BaseColor;}
            ENDHLSL
        }
    }
}
